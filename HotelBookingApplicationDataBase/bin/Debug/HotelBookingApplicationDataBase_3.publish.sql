...
GO
ALTER TABLE [dbo].[Clients] ALTER COLUMN [ClientId] INT NOT NULL;
...
GO
PRINT N'Creating Primary Key unnamed constraint on [dbo].[Clients]...';


GO
ALTER TABLE [dbo].[Clients]
    ADD PRIMARY KEY CLUSTERED ([ClientId] ASC);
